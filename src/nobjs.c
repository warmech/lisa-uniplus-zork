...
L5100:
    if (! findex_1.singsf && (play_1.here == rindex_1.mtree || 
...
L7000:
    if ((i__1 = play_1.here - findex_1.mloc, abs(i__1)) != 1 || 
        mrhere_(play_1.here) != 0 || prsvec_1.prsa != vindex_1.pushw) {
        goto L7100;
    }
    rspeak_(860);
    /* !PUSHED MIRROR WALL. */
...
L13000:
    if (play_1.here == rindex_1.ncell || findex_1.lcell == 4 && 
	    (play_1.here == rindex_1.cell || play_1.here == rindex_1.scorr)) {
        goto L13100;
    }
    rspeak_(763);
    /* !DOOR NOT THERE. */
...
L13100:
    ...
    if (play_1.here == rindex_1.ncell && 
	    (objcts_1.oflag2[oindex_1.odoor - 1] & OPENBT) != 0) {
        rspeak_(766);
    }
    return ret_val;
...
L17000:
    ...
    /* !RELOCATE OLD TO HYPER. */
        if (objcts_1.oroom[i - 1] == rindex_1.cell && 
		    (objcts_1.oflag1[i - 1] & DOORBT) == 0) {
...
L200:
    if (pnf || prsvec_1.prsa != vindex_1.lookiw && 
	    prsvec_1.prsa != vindex_1.examiw && prsvec_1.prsa != vindex_1.lookw) {
        goto L300;
    }
    i__1 = mrbf + 844;
    rspeak_(i__1);
