...
L13000:
    i = robrm_(play_1.here, 100, rindex_1.lld2, 0, 0) + 
	    robadv_(play_1.winner, rindex_1.lld2, 0, 0);
    if (i != 0) {
        rspeak_(162);
    }
    /* !IF ROBBED, SAY SO. */
...
L23000:
    if (prsvec_1.prsa != vindex_1.takew || 
	    objcts_1.ocan[prsvec_1.prso - 1] != 0 || 
		objcts_1.oroom[prsvec_1.prso - 1] != rindex_1.treas ||
...
L37100:
    ...
    newsta_(oindex_1.iboat, 239, objcts_1.oroom[oindex_1.dboat - 1],
        objcts_1.ocan[oindex_1.dboat - 1], objcts_1.oadv[oindex_1.dboat - 1]);
...
L38000:
    ...
    /* !DISMISS READIN, OUT. */
    if (prsvec_1.prsa != vindex_1.boardw || 
	    objcts_1.oadv[oindex_1.stick - 1] != play_1.winner) {
        goto L38100;
    }
