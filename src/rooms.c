...
L13000:
    ...
    /* !WALKIN? */
    if (prob_(50, 50) || 
	    objcts_1.oadv[oindex_1.candl - 1] != play_1.winner || ! 
...
L17500:
    if (prsvec_1.prsa != vindex_1.walkiw || 
	    objcts_1.oadv[oindex_1.garli - 1] == play_1.winner) {
        return ret_val;
    }
    rspeak_(50);
    /* !TIME TO FLY, JACK. */
...
L21500:
    ...
    /* !EXORCISE? */
    if (objcts_1.oadv[oindex_1.bell - 1] == play_1.winner && 
        objcts_1.oadv[oindex_1.book - 1] == play_1.winner && 
		objcts_1.oadv[oindex_1.candl - 1] == play_1.winner && 
		(objcts_1.oflag1[oindex_1.candl - 1] & ONBT) != 0) {
        goto L21600;
    }
...
L24200:
    ...
    /* R25 - CYCLOPS-ROOM. DEPENDS ON CYCLOPS STATE, */
	/* ASLEEP FLAG, MAGIC FLAG. */
...
L27000:
    ...
    i__1 = objcts_1.olnt;
    for (i = 1; i <= i__1; ++i) {
        if (i == oindex_1.chali || i == oindex_1.thief || ! 
		    qhere_(i, play_1.here)) {
            goto L27200;
        }
        j = 83;
    /* !FLAG BYEBYE. */
...
L29000:
    if (! findex_1.buoyf || 
	    objcts_1.oadv[oindex_1.buoy - 1] != play_1.winner) {
        return ret_val;
    }
    rspeak_(84);
    /* !GIVE HINT, */
