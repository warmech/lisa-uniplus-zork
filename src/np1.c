...
L700:
        prep = 0;
        adj = 0;
        /* Go to end of do loop (moved "1000 CONTINUE" to end of module, to */
        /* avoid complaints about people jumping back into the doloop.) */
        goto L1000;
        /* SPARSE, PAGE 10 */
...
L1500:
    ...
    if (orphs_1.oflag != 0 && orphs_1.oprep != 0 && prep == 0 && 
	    pv_1.o1 != 0 && pv_1.o2 == 0 && pv_1.act == orphs_1.oact) {
        goto L11000;
    }
