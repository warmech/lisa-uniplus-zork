...
L5100:
    ...
    /* !TAKE WATER? */
    if (objcts_1.oadv[oindex_1.bottl - 1] == play_1.winner && 
	    objcts_1.ocan[prsvec_1.prso - 1] != oindex_1.bottl) {
        goto L5500;
    }
...
L12100:
    if ((prsvec_1.prsa != vindex_1.attacw && prsvec_1.prsa != vindex_1.killw || 
	    prsvec_1.prsi != oindex_1.rknif) && 
		(prsvec_1.prsa != vindex_1.swingw && 
		prsvec_1.prsa != vindex_1.throww || prsvec_1.prso != oindex_1.rknif)) {
        goto L10;
    }
...
L45100:
    ...
    /* !MAKE LARGE CASE. */
    i = robadv_(play_1.winner, 0, oindex_1.lcase, 0) + 
	    robrm_(play_1.here, 100, 0, oindex_1.lcase, 0);
    jigsup_(261);
    /* !KILL HIM. */
    return ret_val;
    /* OAPPLI, PAGE 8 */
...
L62000:
    if (puzzle_1.cpvec[findex_1.cphere] == -2 || 
	    puzzle_1.cpvec[findex_1.cphere - 2] == -3) {
        goto L62100;
    }
    rspeak_(865);
    /* !NO, LOSE. */
