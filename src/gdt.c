...
L10000:
    if (! (j > 0 && j <= rooms_1.rlnt && (k > 0 && k <= rooms_1.rlnt) && 
	    j <= k)) {
        goto L2200;
    }
    /*  !ARGS VALID? */
...
L11000:
    if (! (j > 0 && j <= objcts_1.olnt && (k > 0 && k <= objcts_1.olnt) && 
	    j <= k)) {
        goto L2200;
    }
    /*  !ARGS VALID? */
...
L12000:
    if (! (j > 0 && j <= advs_1.alnt && (k > 0 && k <= advs_1.alnt) && 
	    j <= k)) {
        goto L2200;
    }
    /*  !ARGS VALID? */
...
L13000:
    if (! (j > 0 && j <= cevent_1.clnt && (k > 0 && k <= cevent_1.clnt) && 
	    j <= k)) {
        goto L2200;
    }
    /*  !ARGS VALID? */
...
L14000:
    if (! (j > 0 && j <= exits_1.xlnt && (k > 0 && k <= exits_1.xlnt) && 
	    j <= k)) {
        goto L2200;
    }
    /*  !ARGS VALID? */
...
L17000:
    if (! (j > 0 && j <= vill_1.vlnt && (k > 0 && k <= vill_1.vlnt) && 
	    j <= k)) {
        goto L2200;
    }
    /*  !ARGS VALID? */
...
L41000:
    if (! (j > 0 && j <= rmsg_1.mlnt && (k > 0 && k <= rmsg_1.mlnt) && 
	    j <= k)) {
        goto L2200;
    }
    /*  !VALID LIMITS? */
