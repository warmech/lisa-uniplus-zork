...
/* CALLED BY - CALL RSPSUB(MSGNUM,SUBNUM) */
void rspsub_(n, s1)
integer n;
integer s1;
{
...
/* CALLED BY - CALL RSPSB2(MSGNUM,SUBNUM1,SUBNUM2) */
...
/* CALLED BY - CALL NEWSTA(OBJECT,STRING,NEWROOM,NEWCON,NEWADV) */
