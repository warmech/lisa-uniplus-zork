...
/* 2024-06-06 - Headers updated for use with UniPlus on the Apple Lisa */
#include <stdio.h>
#include <time.h>
#include <sys/types.h>
#include <sys/times.h>
...
const char *z;
{
    /* 2024-06-06 - Pager code uncommented to allow text to cleanly load on-screen */
...
/* 2024-06-06 - Function renamed from more_input to reset_coutput. This is
 * due to more_input being an already-declared function somewhere else in the
 * C libraries included with UniPlus on the Lisa (but not in the Zork source).
 */
